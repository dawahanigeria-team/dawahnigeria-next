...
export default function RamadanYearNotFound() {
  return (
    <div className="mx-auto max-w-screen-md px-4 py-12 text-center">
      <h1 className="text-2xl font-semibold text-foreground">Archive not found</h1>
      <p className="mt-2 text-sm text-muted-foreground">
        We couldn&apos;t find that Ramadan archive.
      </p>
      <Link
        href={ROUTES.ramadan}
